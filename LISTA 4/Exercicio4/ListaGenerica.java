public class ListaGenerica<T>
{
	...
	protected class Elo
	{
		protected T dado;  //trocar int por T para poder usar qualquer tipo, a complexidade de todos os metodos se mantem inalterada
		protected Elo prox;
	...
	public void insereReverso(T elem) // complexidade O(n)
	{
		Elo p = new Elo(elem);
		Elo q = new Elo();
